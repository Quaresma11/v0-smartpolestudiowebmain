...
const Directions = () => {
  ...
  const directions = [
    ...
    },
    {
      ...
      subtitle: "Функциональные тренировки",
      icon: Users,
      image: "/placeholder.svg?height=300&width=400",
      shortDescription: "Тренировки для повседневной жизни",
      fullDescription:
        "Functional Training — это тренировки, которые готовят тело к повседневным движениям и активностям. Включает упражнения, имитирующие естественные движения человека, развивает стабильность, баланс и координацию.",
      benefits: [
        "Улучшение функциональной силы",
        "Развитие стабильности корпуса",
        "Профилактика травм в быту",
        "Улучшение баланса",
