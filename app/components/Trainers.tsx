  ...
  const trainers = [
    {
      ...
      image: "/images/trainer-ekaterina-new.jpg",
      fullDescription:
    ...
    },
    {
      ...
      image: "/images/trainer-alexey-new.jpg",
      fullDescription:
    ...
    },
    {
      ...
      image: "/images/trainer-maria-new.jpg",
      fullDescription:
    ...
    },
    {
      ...
      image: "/images/trainer-alena-new.jpg",
      fullDescription:
    ...
    {
      name: "Анфиса Ванюкова",
      title: "Тренер по спортивной и воздушной гимнастике",
      experience: "4+ года",
      achievements: ["Тренер олимпийского вида спорта", "2 судейская категория RAPA"],
      specialization: "Спортивная гимнастика, воздушная гимнастика, пилон",
      description:
        "Тренер в олимпийском виде спорта «Спортивная гимнастика» с официальной переквалификацией на воздушную гимнастику.",
      image: "/images/trainer-anfisa.jpg",
      fullDescription:
        "Анфиса — тренер в олимпийском виде спорта «Спортивная гимнастика» с официальной переквалификацией на воздушную гимнастику. Работает с детьми на этапах начальной подготовки, тренировочного этапа и совершенствования спортивного мастерства. За 8 месяцев работы с нуля подготовила воспитанников до 3 взрослого разряда. Тренерская деятельность на протяжении 4 лет по воздушной гимнастике, специализация на снарядах спортивный пилон и воздушные полотна.",
      awards: [
        {
          year: "Образование и квалификация",
          achievements: [
            "Тренер в олимпийском виде спорта «Спортивная гимнастика»",
            "Официальная переквалификация с подтвержденным дипломом",
            "2 судейская категория по воздушной гимнастике RAPA",
            "3 судейская категория по спортивной гимнастике",
          ],
        },
        {
          year: "Результаты воспитанников",
          achievements: [
            "Все разряды до КМС по версии RAPA у воспитанниц",
            "Победители в командном зачете среди всех городов по количеству медалей",
            "Воспитанницы — многократные победители всероссийских соревнований",
            "Официально подтвержденные разряды у воспитанников до 3 взрослого за 8 месяцев",
          ],
        },
        {
          year: "Дополнительное образование",
          achievements: [
            "Курсы по растяжке, пилатесу, силовым тренировкам",
            "Курсы от центра непрерывного образования для тренеров",
            "Внедрение упражнений ЛФК в физическую подготовку спортсменов",
            "Общефизическая и специальнофизическая подготовка спортсменов",
          ],
        },
      ],
    },
